      ...
      body:ListView(children: [
        Container(
          ...
          child:Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
            SizedBox(height: 10),
            Text('Introductiion',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,),),
            SizedBox(height: 20),
        ...
        Container(
          ...
          child:Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
            ...
            SizedBox(height: 20),
             Text('Batchelor in Computer Engineering',
                              style: TextStyle(
        ...
        Container(
          ...
          child:Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
            SizedBox(height: 10),
            Text('Programming',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,),),
            SizedBox(height: 20),
            Text('',)
          ],)
        ),
